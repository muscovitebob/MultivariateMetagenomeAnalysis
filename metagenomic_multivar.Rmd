...
constrainedAbunances1 = bind_cols(separated_X[, 1:3],as.tibble(constrainedModel1$Ybar))
```
...
Exploration using tSNE reveals previously unseen structure in the data that better accounts for clinical status.
